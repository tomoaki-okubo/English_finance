...
abstract class $ChatMessageCopyWith<$Res> {
  ...
  $Res call(
      ...
      @HiveField(1) MessageSender sender,
...
class _$ChatMessageImpl implements _ChatMessage {
  const _$ChatMessageImpl(
      ...
      @HiveField(1) required this.sender,
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, sender, content, timestamp);
...
abstract class _ChatMessage implements ChatMessage {
  const factory _ChatMessage(
      ...
      @HiveField(1) required final MessageSender sender,
      @HiveField(2) required final String content,
      @HiveField(3) required final DateTime timestamp}) = _$ChatMessageImpl;
